    ...
    <header className="bg-white shadow-sm sticky top-0 z-50 border-b border-gray-100">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          <Image
            src="/ask-logo.jpg"
            alt="Ask Travel Trading PLC"
            width={100}
            height={32}
            className="h-11 sm:h-9 w-auto object-contain transition-transform group-hover:scale-105"
            priority
          />
          <div className="flex flex-col">
            <span className="text-xl lg:text-2xl font-bold tracking-tight text-brand-900 leading-none">
              Ask Travel
            </span>
            <span className="text-[12px] text-brand-gold font-semibold uppercase tracking-wider leading-tight">
              Trading PLC
            </span>
          </div>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            href="tel:+251901599959"
            className="ml-2 inline-flex items-center gap-1.5 bg-brand-900 hover:bg-brand-gold hover:text-brand-900 text-white text-sm font-medium px-5 py-2.5 rounded-full transition-colors shadow-sm"
          >
        ...
        <button
          onClick={toggleMenu}
          className="md:hidden p-2 text-brand-900 hover:text-brand-gold transition-colors"
